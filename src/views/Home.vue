    ...
    <v-content>
        ...
        <section id="about">
            ...
            <v-container class="text-center">
                ...
                >
                    <p>
                        Cyber Enthusiastics is an open community and open source
                        platform for anyone related to Cyber. We help you get
                        answers to your coding problems, provide you tutorials
                        and help you get on the right path by allowing all the
                        user to share blogs and posts.
                    </p>
                </v-responsive>
            </v-container>
