  ...
  <v-content>
    ...
    <section id="about">
      ...
      <v-container class="text-center">
        <h2 class="display-2 font-weight-thin mb-3">
          By <b>Cyber Enthusiastics</b> For <b>Cyber Enthusiastics</b>
        </h2>
        ...
        >
          <p>
            Cyber Enthusiastics is an open community and open source platform
            for anyone related to Cyber. We help you get answers to your coding
            problems, provide you tutorials and help you get on the right path
            by allowing all the user to share blogs and posts.
          </p>
        </v-responsive>
      </v-container>
    ...
    <v-footer class="justify-center" color="#292929" height="100">
      <div
        class="title font-weight-thin grey--text text--lighten-1 text-center"
      >
        &copy; {{ new Date().getFullYear() }} Made by Pro-X
      </div>
    </v-footer>
  </v-content>
</template>
