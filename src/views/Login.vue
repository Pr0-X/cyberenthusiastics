    ...
    <v-content>
        ...
        <v-col class="hidden-sm-and-down" cols="4" xl="3">
          <v-card color="primary--text" outlined raised width="100%">
            <v-progress-linear
              ...
              color="green"
            ></v-progress-linear>
            <v-card-title class="login-form-header font-weight-black">
              Login
            </v-card-title>

            <v-card-text>
              <v-form @submit.prevent="login()" lazy-validation method="POST">
                <v-row>
                  <v-col>
                    <v-text-field
                ...
                <v-row>
                  <v-col>
                    <v-checkbox name="remember" label="Remember Me">
                    </v-checkbox>
                  </v-col>
                </v-row>
                ...
                <v-row>
                  ...
                  <v-spacer></v-spacer>
                  <v-col>
                    <v-btn text class="primary--text" @click="forgotPassLink">
      ...
      <v-dialog v-model="unauthorized" max-width="300" light persistent>
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="red darken-1" text @click="unauthorized = false"
              >Try Again</v-btn
            >
          </v-card-actions>
        </v-card>
